...
const imageBlog = [
	{ image: require("./../../images/gallery/pic1.jpg") , tag: ['Designing'], }, 
	...
	{ image: require("./../../images/gallery/pic5.jpg") , tag: ['Finance','Archeology','Construct'], }, 
	{ image: require("./../../images/gallery/pic6.jpg") , tag: ['Development','Construct'], }, 
	{ image: require("./../../images/gallery/pic7.jpg") , tag: ['Archeology','Designing'], }, 
	{ image: require("./../../images/gallery/pic8.jpg") , tag: ['Finance','Archeology'], }, 
	{ image: require("./../../images/gallery/pic9.jpg") , tag: ['Designing'], }, 
	{ image: require("./../../images/gallery/pic1.jpg"),  tag: ['Finance','Designing'], }, 
	{ image: require("./../../images/gallery/pic2.jpg"),  tag: ['Development','Archeology','Designing'], },  
	{ image: require("./../../images/gallery/pic3.jpg"),  tag: ['Development','Archeology'], },   
]
						...
						<ul className="dez-gallery-listing gallery-grid-4 gallery mfp-gallery sp10">
							...
							>
								...
								{filteredImages.map((item, index)=>(	
									<li className="web design card-container col-lg-3 col-md-4 col-sm-6 col-6" key={index}>
